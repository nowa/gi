...
func init() {
	...
	RegisterModel(Model{ID: "deepseek-v4-flash", Name: "deepseek-v4-flash", Provider: "deepseek", API: "openai-completions", Reasoning: true, Input: []string{"text"}, ThinkingLevelMap: map[string]*string{"minimal": nil, "low": nil, "medium": nil, "high": ptrString("high"), "xhigh": ptrString("xhigh")}})
